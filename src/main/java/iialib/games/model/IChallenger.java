...
public interface IChallenger {
    ...
    /**
     * L'arbitre vous signale que la partie s'est soldée car elle a trop durée.
     * @return un petit message ou une bannière de partie finie au-delà du temps imparti.
     */
    // String timeout();

    /**
     * L'arbitre vous signale que la partie s'est soldée car un des joueurs a commit un coup illégal.
     * @return un petit message ou une bannière de partie finie pour cause de coup illégal.
     */
    // String illegal_move();
    // POUR ALLER PLUS LOIN, donner directement l'interface IChallenger complète dès la première partie (an prochain)
